                ...
                <div className="relative w-full h-full">
                    <div className="flex justify-between border-b border-white/20 items-center px-5 py-4">
                        <div className="flex items-center">
                            ...
                            <p className="font-extrabold ml-1 text-2xl">MyApp</p>
                        </div>
...
const Header = ({ $, NavItems }) => {
    ...
    return (
        <>
                ...
                <div className="max-w-7xl px-5 mx-auto py-5 flex items-center justify-between">
                    <div className="flex items-center space-x-6">
                        <div className="flex items-center space-x-3">
                            ...
                            <p className="text-xl text-white font-semibold">
                                <a href="/"><span className="text-amber-400">My</span>App</a>
                            </p>
                        </div>
                    ...
                    <div className="flex items-center space-x-2 relative">
                        ...
                        <Menu as="div" className="relative text-left">
                            ...
                            >
                                <Menu.Items className="absolute z-50 text-base right-0 p-1 w-56 mt-2 origin-top-right border bg-white border-black/10 dark:border-white/10 dark:bg-black rounded-md shadow-lg ring-1 ring-black ring-opacity-5">
            ...
            <MobileNavbar open={open} setOpen={setOpen} NavItems={NavItems} />
        </>
    );
};
